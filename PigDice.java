...
private void Roll(int roundPoints)
{
    ...
    if (decision == 0)
    {
	    ...
	    if (dieResult == 1)
	    {
	    System.out.println("Player " + PlayerTurn + "rolled 1 and busted.");
	    } 
	    else 
	    {
	    System.out.println("Player " + PlayerTurn + " rolled " + dieResult);
	...
	else 
	{
		...
		System.out.println("Player " + PlayerTurn + "earned " + roundPoints + " points.");
	}
}
